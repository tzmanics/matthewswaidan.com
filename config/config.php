...
configurations found in /core/config/config.php;
...
define('APP_NAME', 'Simple Wood Goods');

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
define('APP_EMAIL', 'mswaidan@gmail.com');
...
*/
define('SYSTEM_EMAIL', 'mswaidan@gmail.com');

# Default DB name for this app
define('DB_NAME', 'matthewswaidan_loc');
